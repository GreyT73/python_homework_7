...
Винни-Пух вбивает в программу с клавиатуры. В ответе напишите “Парам пам-пам”, если с ритмом
...
glasnye = 'АИОУЫЭЕЁЮЯ'
poetry = input("Введите стихотворение Винни-Пуха: ").split()

length = list(map(lambda y: len([x for x in y if x.upper() in glasnye]), poetry))
length_2 = list(filter(lambda x: x == length[0], length))
if length == length_2:
    print("Парам пам-пам")
else:
    print('Пам парам')